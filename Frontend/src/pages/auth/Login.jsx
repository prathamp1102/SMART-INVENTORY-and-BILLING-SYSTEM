...
export default function Login() {
  ...
  if (screen === "role") return (
    <div style={{ opacity: transitioning ? 0 : 1, transform: transitioning ? "scale(.97)" : "scale(1)", transition: "all .28s", display: "flex", flexDirection: "column", alignItems: "center", width: "100%", maxWidth: "min(1020px, 100%)", padding: "0 24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(140px, 100%), 1fr))", gap: "16px", width: "100%", animation: "fadeUp .6s ease .28s both" }}>
