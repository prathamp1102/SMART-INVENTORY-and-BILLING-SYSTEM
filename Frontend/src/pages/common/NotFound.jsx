    ...
    <div style={{ width:"100vw",height:"100vh",background:"#f5f3ee",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"'Poppins',sans-serif" }}>
      <div style={{ background:"#fff",borderRadius:"24px",border:"1px solid rgba(26,26,46,.08)",boxShadow:"0 8px 40px rgba(26,26,46,.1)",padding:"48px 52px",textAlign:"center",maxWidth: "min(400px, 100%)",width:"90%" }}>
        ...
        <button onClick={() => navigate(-1)}
          style={{ padding:"11px 28px",borderRadius:"12px",border:"1.5px solid rgba(26,26,46,.14)",cursor:"pointer",fontFamily:"'Poppins',sans-serif",fontSize:"14px",fontWeight:700,background:"#fff",color:"#1a1a2e",boxShadow:"0 2px 8px rgba(26,26,46,.08)" }}>
          Go Back
        </button>
      </div>
    </div>
